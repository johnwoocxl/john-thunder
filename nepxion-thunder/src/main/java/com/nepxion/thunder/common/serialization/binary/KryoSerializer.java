package com.nepxion.thunder.common.serialization.binary;
...
public class KryoSerializer {
    ...
    public static byte[] serialize(Serializable object, int bufferSize, int maxBufferSize) {
        if (object == null) {
    ...
    public static byte[] serialize(Kryo kryo, Serializable object) {
        return serialize(kryo, object, KryoConstants.BUFFER_SIZE, KryoConstants.MAX_BUFFER_SIZE);
    }

    public static byte[] serialize(Kryo kryo, Serializable object, int bufferSize, int maxBufferSize) {
        if (object == null) {
            throw new SerializerException("Object is null");
        }
