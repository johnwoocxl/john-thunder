...
import com.nepxion.thunder.common.entity.ApplicationEntityFactory;
import com.nepxion.thunder.common.entity.ApplicationType;
import com.nepxion.thunder.common.entity.InstanceEvent;
import com.nepxion.thunder.common.entity.InstanceEventType;
...
public class ZookeeperInstanceWatcher extends ZookeeperPathChildrenCacheListener {
    ...
    private void onEvent(PathChildrenCacheEvent event, InstanceEventType instanceEventType) throws Exception {
        ...
        ApplicationEntity applicationEntity = ApplicationEntityFactory.fromJson(applicationJson);
        
        List<String> applicationJsonList = invoker.getChildNameList(client, path);
        List<ApplicationEntity> applicationEntityList = ApplicationEntityFactory.fromJson(applicationJsonList);
